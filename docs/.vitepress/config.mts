...
// 替换原有彩带脚本，用这个极简版（无依赖、强制显示）
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '📚小说',
        items: [
              { text: '《梦游记》', link: '/小说/梦游记' },
              { text: '《长生贼》', link: '/小说/长生贼' },
              { text: '《度苦记》', link: '/小说/度苦记' },
              { text: '《火种》', link: '/小说/火种' },
              { text: '《回魂》', link: '/小说/回魂' },
              { text: '《三灾》', link: '/小说/三灾' },
              { text: '《往生》', link: '/小说/往生' },
              { text: '《盗亦有道》', link: '/小说/盗亦有道' },
              { text: '《死环》', link: '/小说/死环' },
            ]
       },
       { text: '🙂面试', 
        items: [
              { text: 'HTML', link: '/面试/HTML' },
              { text: 'CSS', link: '/面试/CSS' },
              { text: 'JavaScript', link: '/面试/JavaScript' },
              { text: 'TypeScript', link: '/面试/TypeScript' },
              { text: 'React', link: '/面试/React' },
              { text: 'Next', link: '/面试/Next' },
              { text: '计网', link: '/面试/计网' },
              { text: '工程化', link: '/面试/工程化' },
      ...
      '/CSS/': [
        {
          ...
          items: [
            ...
            { text: '核心布局方案', link: '/面试/CSS/核心布局方案' },
            { text: '响应式布局', link: '/面试/CSS/响应式布局' },
            { text: '样式管理及工程化', link: '/面试/CSS/样式管理及工程化' },
            { text: '高频面试题解析', link: '/面试/CSS/高频面试题解析' },
          ]
        }
      ],
       '/算法/': [
       ...
       '/面试/': [
        {
          ...
          items: [
            ...
            { text: 'React', link: '/面试/React' },
            { text: 'Next', link: '/面试/Next' },
            { text: 'Nest', link: '/面试/Nest' },
            { text: 'SSE', link: '/面试/SSE' },
            { text: '工程化', link: '/面试/工程化' },
            { text: '计网', link: '/面试/计网' },
            { text: '浏览器', link: '/面试/浏览器' },
            { text: '前沿技术', link: '/面试/前沿技术' },
          ]
        }
      ],
    },
