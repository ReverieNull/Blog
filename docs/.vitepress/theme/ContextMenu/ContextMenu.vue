...
import './SvgRender.vue'
import { Arrow, Copy, FullScreen, NonFullScreen, Refresh } from "./SvgList.ts";
...
html.dark .context-menu-var {
  ...
  --theme-color: #f69a5c;
  // 标题颜色
  --title-text-color: #f2933b;
  // 头部背景色
  --header-bg-color: linear-gradient(to right, #483b2a, #442626);
  // 文本颜色
  --text-color: #ffffff;
  // 菜单背景颜色
  --menu-bg-color: #2d211b;
  // 菜单项鼠标悬停背景颜色
  --menu-hover-bg-color: #ae4015;
  // 分割线颜色
  --divider-bg-color: #551212;
}
...
.menu-item:hover {
  ...
  box-shadow: 0 2px 8px rgba(163, 0, 0, 0.1);
}
...
.submenu-item:hover {
  background-color: var(--menu-hover-bg-color);
  transform: translateX(2px);
  box-shadow: 0 2px 8px rgba(79, 0, 0, 0.1);
}
...
.menu-footer-item {
  margin: 6px 8px;
  background: linear-gradient(135deg, #f68a5c, #ec4848);
...
.menu-footer-item:hover {
  background: linear-gradient(135deg, #fa8b8b, #f4e772);
  box-shadow:
    0 5px 15px rgba(197, 246, 92, 0.4),
    0 2px 5px rgba(209, 236, 72, 0.3);
